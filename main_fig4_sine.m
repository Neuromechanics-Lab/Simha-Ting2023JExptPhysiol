...
saveCurrentWithForce('results_file_bag',results_file_bag,'results_file_chain',results_file_chain,'t',t,...
            'r',r,'rs',rs,'rd',rd,'parms',parms,'outputfilename',sprintf('%sSim%ipCa%iFreq%iAmp%i.mat',results_base_file,parms.simNo,round(parms.pCa*10),round(parms.freq),round(parms.amp*10000)));